...
describe('markdown export html', () => {
  it('embeds Typora GitHub default theme styles', () => {
    ...
    expect(html).toContain('.markdown-body thead ~ tbody tr:nth-child(even)')
    expect(html).toContain('.markdown-body table > tbody:first-child tr:nth-child(odd)')
    expect(html).toContain('.markdown-body tr[data-is-header]')
