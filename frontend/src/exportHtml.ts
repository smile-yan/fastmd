...
const ALLOWED_ATTRS: Record<string, Set<string>> = {
  ...
  th: new Set(['colspan', 'rowspan', 'scope', 'id', 'class', 'style']),
  td: new Set(['colspan', 'rowspan', 'id', 'class', 'style']),
  tr: new Set(['id', 'class', 'data-is-header']),
  ol: new Set(['start', 'type', 'id', 'class']),
  li: new Set(['value', 'id', 'class', 'data-type', 'data-checked', 'data-item-type', 'data-label', 'data-list-type', 'data-spread']),
  dl: new Set(['id', 'class', 'data-label']),
  sup: new Set(['id', 'class', 'data-label']),
